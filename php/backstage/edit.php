...
if($_SERVER["REQUEST_METHOD"]==="POST"){
    ...
    if(mysqli_num_rows(mysqli_query($conn,$check))>0){
        ...
        $updateCarParks="UPDATE CarParks SET CarParkID='$CarParkID',CarParkName_Zh_tw='$CarParkName_Zh_tw',OperatorID='$OperatorID',`Description`='$Description',
        CarParkType='$CarParkType',ParkingGuideType='$ParkingGuideType',CarParkPosition_PositionLat='$CarParkPosition_PositionLat',
        CarParkPosition_PositionLon='$CarParkPosition_PositionLon',`Address`='$Address',FareDescription='$FareDescription',IsMotorcycle='$IsMotorcycle',
        LiveOccuppancyAvailable='$LiveOccuppancyAvailable',EVRechargingAvailable='$EVRechargingAvailable',MonthlyTicketAvailable='$MonthlyTicketAvailable',
        SeasonTicketAvailable='$SeasonTicketAvailable',ReservationAvailable='$ReservationAvailable',WheelchairAccessible='$WheelchairAccessible',
        OvernightPermitted='$OvernightPermitted',Toilet='$Toilet',Restaurant='$Restaurant',GasStation='$GasStation',Shop='$Shop',Lighting='$Lighting',
        SecureParking='$SecureParking',SecurityGuard='$SecurityGuard',Supervision='$Supervision' WHERE CarParkID='$originCarParkID' AND  CarParkName_Zh_tw='$originCarParkName_Zh_tw'";
